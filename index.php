...
<body>
    ...
    <?php
        ...
        if(isset($_POST['Submit'])) {
            ...
            $tiket = mysqli_query($mysqli, "INSERT INTO users(tanggal,id_user,subject,departemen,keluhan,status) VALUES('$tanggal','$id_user','$subject','$departemen','$keluhan','$status')");
