    ...
    <thead bgcolor="eeeeee" align="center">
        ...
        <?php
          ...
          if (isset($_GET['id'])) {
            ...
            $result = mysqli_query($mysqli, "SELECT e.id, e.id_user, e.tanggal, e.subject, e.departemen, e.keluhan, e.status, d.id_user FROM users e JOIN tb_user d ON (e.id_user = d.id_user) WHERE d.id_user=$id_user");
